...
impl ElizaCloudConfig {
    pub fn new(api_key: impl Into<String>) -> Self {
        Self {
            ...
            small_model: "gpt-5.4-mini".to_string(),
            large_model: "claude-sonnet-4.6".to_string(),
            embedding_model: "text-embedding-3-small".to_string(),
            embedding_dimensions: 1536,
            embedding_api_key: None,
            embedding_url: None,
            image_description_model: "gpt-5.4-mini".to_string(),
...
mod tests {
    ...
    fn test_config_defaults() {
        ...
        assert_eq!(config.small_model, "gpt-5.4-mini");
        assert_eq!(config.large_model, "claude-sonnet-4.6");
